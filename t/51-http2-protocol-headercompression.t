...
use PageCamel::Protocol::HTTP2::Constants qw(:endpoints :limits :settings);

BEGIN {
    use_ok( 'PageCamel::Protocol::HTTP2::HeaderCompression',
...
subtest 'decode responses' => sub {
    my $decoder = PageCamel::Protocol::HTTP2::HeaderCompression->new;
