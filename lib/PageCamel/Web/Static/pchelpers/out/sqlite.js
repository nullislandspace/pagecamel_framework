...
export class PCSqlite {
            ...
            if (initSqlJs instanceof Function) {
                ...
                initSqlJs(config).then((SQL) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (this._loadFromExternalStorage) {
                        var data = yield this._loadFromExternalStorage();
                        if (data) {
    ...
    set saveToExternalStorage(func) {
        this._saveToExternalStorage = func;
    }
    get saveToExternalStorage() {
        return this._saveToExternalStorage;
    }
    set loadFromExternalStorage(func) {
