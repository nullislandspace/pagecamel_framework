CVCEDITOR.plugins.add('cavacfiles', {
    icons: 'cavacfiles',
    init: function(editor) {
        editor.addCommand('cavacfiles', new CVCEDITOR.dialogCommand('cavacFilesDialog'), {
        ...
        CVCEDITOR.dialog.add( 'cavacFilesDialog', this.path + 'dialogs/cavacfiles.js' );
        ...
        if(editor.contextMenu) {
            ...
            editor.contextMenu.addListener( function(element) {
                ...
                if(isCavacFiles) {
                    return { cavacfilesItem: CVCEDITOR.TRISTATE_OFF};
                }
