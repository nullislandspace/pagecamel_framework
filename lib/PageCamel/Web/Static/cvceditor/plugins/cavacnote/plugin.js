CVCEDITOR.plugins.add('cavacnote', {
    icons: 'cavacnote',
    init: function(editor) {
        editor.addCommand('cavacnote', new CVCEDITOR.dialogCommand('cavacNoteDialog'), {
        ...
        CVCEDITOR.dialog.add( 'cavacNoteDialog', this.path + 'dialogs/cavacnote.js' );
        ...
        if(editor.contextMenu) {
            ...
            editor.contextMenu.addListener( function(element) {
                ...
                if(isCavacNote) {
                    return { cavacnoteItem: CVCEDITOR.TRISTATE_OFF};
                }
