CVCEDITOR.dialog.add( 'cavacNoteDialog', function( editor ) {
    return {
        title: 'Cavac Note',
        minWidth: 400,
        minHeight: 200,
                ...
                elements: [
                    {
                        ...
                        id: 'visibletext',
                        label: 'Visible text',
                        validate: CVCEDITOR.dialog.validate.notEmpty( "Visible text field cannot be empty." ),
                    ...
                    },
                    {
                        ...
                        id: 'popuptext',
                        label: 'Popup text',
                        validate: CVCEDITOR.dialog.validate.notEmpty( "Popup text field cannot be empty." ),
                        setup: function( element ) {
