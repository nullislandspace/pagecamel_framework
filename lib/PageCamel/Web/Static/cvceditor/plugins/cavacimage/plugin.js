CKEDITOR.plugins.add('cavacimage', {
    icons: 'cavacimage',
    init: function(editor) {
        editor.addCommand('cavacimage', new CKEDITOR.dialogCommand('cavacImageDialog'), {
        ...
        CKEDITOR.dialog.add( 'cavacImageDialog', this.path + 'dialogs/cavacimage.js' );
        ...
        if(editor.contextMenu) {
            ...
            editor.contextMenu.addListener( function(element) {
                ...
                if(isCavacImage) {
                    return { cavacimageItem: CKEDITOR.TRISTATE_OFF};
                }
