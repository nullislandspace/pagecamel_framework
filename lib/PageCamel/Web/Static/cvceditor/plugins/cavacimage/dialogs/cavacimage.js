CVCEDITOR.dialog.add( 'cavacImageDialog', function( editor ) {
    return {
        title: 'Cavac Image',
        minWidth: 1200,
        minHeight: 600,
                ...
                elements: [
                    {
                        ...
                        id: 'src',
                        label: 'Relative Path',
                        validate: CVCEDITOR.dialog.validate.notEmpty( "Path can not be empty" ),
                        //validate: CVCEDITOR.dialog.validate.notEmpty( "Popup title field cannot be empty." ),
...
var cvceditor_image_selector_prepared = 0;
function prepareImageSelector() {
    if(cvceditor_image_selector_prepared == 1) {
        return;
    }
    ...
    cvceditor_image_selector_prepared = 1;
}
