...
function setCanvasWindowSize(canvas) {
    ...
    if (window.screen.width * window.devicePixelRatio > 1300) {
        canvas.width = window.screen.width * window.devicePixelRatio - 300;
    }
    else {
        canvas.width = window.screen.width * window.devicePixelRatio;
    }
    if (window.screen.height * window.devicePixelRatio > 1000) {
        canvas.height = window.screen.height * window.devicePixelRatio - 200;
    }
    else {
