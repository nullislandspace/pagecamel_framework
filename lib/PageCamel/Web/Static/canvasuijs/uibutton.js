class UIButton {
    ...
    add(options) {
        /*  required: x: number, y: number, width: number, 
            ...
            border: '#000000', align: String ('left', 'right', 'center'), displaytext: String, accept_keycode: [keycode1, keycode2, ...],
        */
        options.active = true;
...
canvasuijs.addType('Button', UIButton);