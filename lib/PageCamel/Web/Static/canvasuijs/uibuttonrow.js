class UIButtonRow {
    ...
    add(options) {
        ...
        options.edit = () => {
            if (!options.editable) {
                var x = options.x + (options.button.buttons[0].width + options.gap) * options.button.buttons.length;
                var height = options.button.buttons[0].height;
                var y = options.button.buttons[0].y;
                var width = height;
                options.add_button.add({
                    ...
                    callback: () => {
                        options.change_name.add({
                            background: ['#cecece'], foreground: '#a9a9a9', border: '#39f500',
                            ...
                            type: 'textInput', displaytext: 'Raum Name:', text: '123'
                        });
            ...
            if (!buttonrow.inputDisabled) {
                ...
                if (buttonrow.mouse_down_on) {
                    ...
                    if (index > 0) {
                        ...
                        console.log(buttonrow.mouse_down_on_elements);
