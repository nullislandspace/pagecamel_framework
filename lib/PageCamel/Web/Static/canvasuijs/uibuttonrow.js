    ...
    add(options) {
        ...
        options.dialogClose = (action) => {
            if (action == 'ok') {
                ...
                var element_options = Object.assign({}, { displaytext: room_name, background: ['#31A2F2'], foreground: '#000000' }, options.elementOptions);
