            ...
            if (invoices[invoices.length - 1].lineitem[0].displaytext != 'BAR') {
                ...
                for (var i in articles) {
                    for (var j in invoices) {
                        if (invoices[j].article == articles[i].article) {
                            articles[i].qty -= invoices[j].qty; // do with item id !!!!!!!!
                        }
                    }
                }
                ...
                /*if (this.invoiceRight[this.invoiceRight.length - 1] !== undefined) {
                    //check if invoice finished or not
                    if (this.invoiceRight.length > 1 && this.invoiceRight[this.invoiceRight.length - 1].lineitem[0].displaytext == 'BAR') {
                        if (this.invoiceLeft[this.invoiceLeft.length - 1] !== undefined) {
                            if (this.invoiceLeft.length > 1 && this.invoiceLeft[this.invoiceLeft.length - 1].lineitem[0].displaytext == 'BAR') {
                                */
