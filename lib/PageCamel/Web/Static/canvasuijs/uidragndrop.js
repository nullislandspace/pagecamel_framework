class UIDragNDrop {
    ...
    render(ctx) {
        ...
        for (var i in this.dragndrops) {
            ...
            if (dragndrop.editable == true) {
                ...
                // draw a red line
                /*ctx.beginPath();
                ctx.moveTo(dragndrop.x, dragndrop.y);
                ctx.lineTo(dragndrop.x, dragndrop.y + dragndrop.height);
                ctx.stroke();*/
            }
        }
    ...
    onMouseMove(x, y) {
        if (this.mouse_down) {
            ...
            if (dragndrop.mouse_down_action != '') {
                ...
                var new_bottom_left_x = new_top_left_x + dragndrop.width;
                var new_bottom_left_y = new_top_left_y + dragndrop.height;
                ...
                if (new_bottom_left_x > dragndrop.contain_x + dragndrop.contain_width) {
                    new_top_left_x = dragndrop.contain_x + dragndrop.contain_width - dragndrop.width;
                }
                if (new_bottom_left_y > dragndrop.contain_y + dragndrop.contain_height) {
