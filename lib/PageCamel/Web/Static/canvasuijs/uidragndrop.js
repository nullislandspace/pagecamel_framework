class UIDragNDrop {
    ...
    render(ctx) {
        ...
        for (var i in this.dragndrops) {
            ...
            if (dragndrop.editable == true && dragndrop.selected == true) {
                ...
                ctx.lineWidth = 5;
                //var [corners_x, corners_y] = this.calculateCornerPositions(dragndrop.x + dragndrop.x + dragndrop.width / 2 - dragndrop.center_x, dragndrop.y + dragndrop.y + dragndrop.height / 2 - dragndrop.center_y, dragndrop.width, dragndrop.height, -dragndrop.angle);
                //var [center_x, center_y] = rotate(dragndrop.center_x, dragndrop.center_y, dragndrop.x + dragndrop.width / 2, dragndrop.y + dragndrop.height / 2, -dragndrop.angle);
    ...
    calculateCornerPositions(x, y, width, height, angle) {
        ...
        var corners_y = [rotate(center_x, center_y, x, y, angle)[1], rotate(center_x, center_y, x + width, y, angle)[1],
        rotate(center_x, center_y, x + width, y + height, angle)[1], rotate(center_x, center_y, x, y + height, angle)[1]];
    ...
    onMouseMove(x, y) {
        if (this.mouse_down) {
            ...
            if (dragndrop.mouse_down_action != '' && dragndrop.editable == true && dragndrop.selected) {
                this.calculateCornerPositions(x, y, dragndrop.width, dragndrop.height, dragndrop.angle);
                ...
                if (dragndrop.mouse_down_action == 'crosshair') {
                    console.log(dragndrop.center_x, dragndrop.center_y);
