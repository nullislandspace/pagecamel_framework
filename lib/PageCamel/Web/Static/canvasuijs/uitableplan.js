class UITablePlan {
    ...
    add(options) {
        ...
        options.setSQLData = () => {
            console.log(options.background_imgs);
                ...
                if (uitableplan.editable == false) {
                    ...
                    if (uitableplan.selected != null) {
                        ...
                        uitableplan.textinput.add({
                            displaytext: uitableplan.selected.displaytext, name: 'posx',
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 - 350, y: uitableplan.y + uitableplan.height - this.bottom_bar_height  + 10, width: 190, height: 50, font_size: 30, align: 'left'
                        })
                    }
                    if (uitableplan.selected != null) {
                        //color Selector
