                ...
                if (uitableplan.editable == false) {
                    ...
                    if (uitableplan.selected != null) {
                        ...
                        uitableplan.textinput.add({
                            displaytext: String(Math.round(uitableplan.selected.x - uitableplan.x - offset_x)), name: 'posx', type: 'number',
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 + 10, y: uitableplan.y + 40,
                            width: 190, height: 40, font_size: 25, align: 'left',
                            callback: (posx) => {
                                var offset_x = this.getOffsetX(uitableplan);
                        ...
                        uitableplan.textinput.add({
                            displaytext: String(Math.round(uitableplan.selected.y - uitableplan.y - offset_y)), name: 'posy', type: 'number',
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 + 10, y: uitableplan.y + 90,
                            width: 190, height: 40, font_size: 25, align: 'left',
                            callback: (posy) => {
                                var offset_y = this.getOffsetY(uitableplan);
                                ...
                                console.log('MAX Y', max_y_corner, 'limit:', uitableplan.y + uitableplan.height - this.bottom_bar_height)
