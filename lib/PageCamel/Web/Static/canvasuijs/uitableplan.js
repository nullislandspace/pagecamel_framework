                ...
                if (uitableplan.editable == false) {
                    ...
                    if (uitableplan.selected != null) {
                        ...
                        uitableplan.textinput.add({
                            ...
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 + 60, y: uitableplan.y + 40,
                            width: 80, height: 40, font_size: 25, align: 'left',
                            callback: (posx) => {
                                var offset_x = this.getOffsetX(uitableplan);
                        ...
                        uitableplan.textinput.add({
                            ...
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 + 60, y: uitableplan.y + 90,
                            width: 80, height: 40, font_size: 25, align: 'left',
                            callback: (posy) => {
                                var offset_y = this.getOffsetY(uitableplan);
                        ...
                        uitableplan.textinput.add({
                            ...
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 + 90, y: uitableplan.y + 140,
                            width: 80, height: 40, font_size: 25, align: 'left', callback: (height) => {
                                var max_height;
                                var [x_corners, y_corners] = uitableplan.dragndrop.calculateCornerPositions(uitableplan.selected.x, uitableplan.selected.y, uitableplan.selected.width, uitableplan.selected.height, uitableplan.selected.angle);
                                var center_x = (x_corners[0] + x_corners[1] + x_corners[2] + x_corners[3]) / 4;
                                var center_y = (y_corners[0] + y_corners[1] + y_corners[2] + y_corners[3]) / 4;
                        ...
                        uitableplan.textinput.add({
                            ...
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 + 90, y: uitableplan.y + 190,
                            width: 80, height: 40, font_size: 25, align: 'left', callback: (width) => {
                                var max_width;
                                var [x_corners, y_corners] = uitableplan.dragndrop.calculateCornerPositions(uitableplan.selected.x, uitableplan.selected.y, uitableplan.selected.width, uitableplan.selected.height, uitableplan.selected.angle);
                                var center_x = (x_corners[0] + x_corners[1] + x_corners[2] + x_corners[3]) / 4;
                                var center_y = (y_corners[0] + y_corners[1] + y_corners[2] + y_corners[3]) / 4;
                        ...
                        uitableplan.textinput.add({
                            ...
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 + 90, y: uitableplan.y + 240,
                            width: 80, height: 40, font_size: 25, align: 'left', callback: (angle) => {
