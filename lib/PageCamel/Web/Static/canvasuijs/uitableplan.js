class UITablePlan {
    ...
    add(options) {
        ...
        options.buttonrow.add({
            name: 'rooms',
            x: options.x + 10, y: options.y + options.height - this.bottom_bar_height + 10, width: options.width - 225, height: 80, gap: 10,
            //callback: buttonSendMessage,
            //callbackData: { key: "ZAHLUNGSART_SELECTREST" },
            elementOptions: {
                background: ['#4fbcff', '#009dff'],
                hover_border: '#009dff',
                foreground: '#000000',
                border: '#4fbcff',
                border_width: 3,
        ...
        options.buttonrow.find('rooms').setList([{ displaytext: 'Hallo' }, { displaytext: 'Test' }, { displaytext: 'Raum' },])
    ...
    onClick(x, y) {
        ...
        for (var i in this.uitableplans) {
            ...
            this.uitableplans[i].buttonrow.onClick(x, y);
        }
    ...
    onMouseDown(x, y) {
        for (var i in this.uitableplans) {
            this.uitableplans[i].buttonrow.onMouseDown(x, y);
            var uitableplan = this.uitableplans[i];
    ...
    onMouseUp(x, y) {
        for (var i in this.uitableplans) {
            ...
            if (uitableplan.active == true) {
                ...
                this.uitableplans[i].buttonrow.onMouseUp(x, y);
    ...
    onMouseMove(x, y) {
        for (var i in this.uitableplans) {
            var uitableplan = this.uitableplans[i];
            if (uitableplan.active) {
                this.uitableplans[i].buttonrow.onMouseMove(x, y);
    ...
    clear() {
        ...
        for (var i in this.uitableplans) {
            ...
            this.uitableplans[i].buttonrow.clear();
        }
    }
}
