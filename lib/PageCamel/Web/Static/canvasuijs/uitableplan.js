        ...
        for (var i in this.uitableplans) {
            ...
            if (uitableplan.editable == false) {
                ...
                for (var j in uitableplan.rects) {
                    ...
                    this.dragndrop.add({
                        displaytext: '0', name: 'tbox', contain_x: uitableplan.x, contain_y: uitableplan.y, contain_width: uitableplan.width - 225, contain_height: uitableplan.height - 70,
                        background: ['#0d05ff'], foreground: '#000000', border: '#0579ff', border_width: 3, grd_type: 'vertical',
