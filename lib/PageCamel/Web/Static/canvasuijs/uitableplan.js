        ...
        for (var i in this.uitableplans) {
            ...
            if (uitableplan.editable == false) {
                ...
                this.button.add({
                    ...
                    x: uitableplan.x + uitableplan.width - 105, y: uitableplan.y + 310, width: 100, height: 100, border_radius: 20, font_size: 40, hover_border: '#cc000a',
            ...
            if (uitableplan.editable == true && (uitableplan.circle == true || uitableplan.rect == true) && uitableplan.draw.mousedown_x != null) {
                ...
                if (uitableplan.rect) {
                    this.dragndrop.add({
                        ...
                        x: x, y: y, width: width, height: height, font_size: 15, angle: 0, callback: uitableplan.addToUndoable
                    });
                }
                else if (uitableplan.circle) {
                    this.dragndrop.add({
