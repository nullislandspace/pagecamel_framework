        ...
        for (var i in this.uitableplans) {
            ...
            if (uitableplan.editable == false) {
                ...
                for (var j in uitableplan.rects) {
                    ...
                    this.dragndrop.add({
                        displaytext: 'Hello World', name: 'tbox', contain_x: uitableplan.x, contain_y: uitableplan.y, contain_width: uitableplan.width - 225, contain_height: uitableplan.height - 70,
