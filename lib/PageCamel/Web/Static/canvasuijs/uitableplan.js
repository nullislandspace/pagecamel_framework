        ...
        options.redo = () => {
            if (options.redoable[options.active_room] != undefined) {
                if (options.redoable[options.active_room].length > 0) {
                    ...
                    if (options.circle || options.rect || options.image) {
                        options.dragndrop.setEditable(options.active_room, false);
                    }
    ...
    update() {
            ...
            if (uitableplan.active) {
                if (uitableplan.editable == false) {
                    ...
                    uitableplan.button.add({
                        ...
                        x: uitableplan.x + 430, y: uitableplan.y + uitableplan.height - 60, width: 50, height: 50, border_radius: 10, font_size: 30, hover_border: '#cc000a',
                    ...
                    uitableplan.button.add({
                        ...
                        x: uitableplan.x + uitableplan.width - 530, y: uitableplan.y + uitableplan.height - 60, width: 150, height: 45, border_radius: 20, font_size: 18,
                    ...
                    if (uitableplan.selected != null) {
                        uitableplan.textinput.add({
                            ...
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 100, y: uitableplan.y + 500, width: 90, height: 50, font_size: 30, align: 'left',
                        ...
                        uitableplan.textinput.add({
                            ...
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 + 50, y: uitableplan.y + 40,
                            width: 150, height: 40, font_size: 25, align: 'left',
                            callback: (posx) => {
                                var offset_x = this.getOffsetX(uitableplan);
                        ...
                        uitableplan.textinput.add({
                            ...
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 + 50, y: uitableplan.y + 90,
                            width: 150, height: 40, font_size: 25, align: 'left',
                            callback: (posy) => {
                                var offset_y = this.getOffsetY(uitableplan);
                        ...
                        uitableplan.textinput.add({
                            ...
                            background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                            x: uitableplan.x + uitableplan.width - 225 + 70, y: uitableplan.y + 140,
                            width: 130, height: 40, font_size: 25, align: 'left', callback: (height) => {
                                if (height > uitableplan.dragndrop.box_size + 2) {
                                    uitableplan.selected.height = parseInt(height);
                                }
                                else if (height < uitableplan.dragndrop.box_size + 2) {
                                ...
                                if (max_x_corner > uitableplan.x + uitableplan.width - 225) {
                                    uitableplan.selected.height = x_corners[1] - x_corners[0];
                                    console.log('Setting new height:', uitableplan.selected.height);
                    }

                    var [x_corners, y_corners] = uitableplan.dragndrop.calculateCornerPositions(uitableplan.selected.x, uitableplan.selected.y, uitableplan.selected.width, uitableplan.selected.height, uitableplan.selected.angle);
                    var center_x = (x_corners[0] + x_corners[1] + x_corners[2] + x_corners[3]) / 4
                    uitableplan.selected.center_x = center_x;
                }
            });
        }
        if (uitableplan.selected != null) {
            ...
            uitableplan.button.add({
                ...
                background: ['#4fbcff', '#009dff'], foreground: '#000000', border: '#4fbcff', border_width: 3, grd_type: 'vertical',
                x: uitableplan.x + 490, y: uitableplan.y + uitableplan.height - 60, width: 120, height: 50, border_radius: 10, font_size: 20, hover_border: '#009dff',
        ...
        if (uitableplan.background_imgs[uitableplan.active_room] !== undefined) {
            uitableplan.button.add({
                displaytext: "✕",
                background: ['#ff0000', '#cc000a'], foreground: '#000000', border: '#ff0000', border_width: 3, grd_type: 'vertical',
                x: uitableplan.x + uitableplan.width - 585, y: uitableplan.y + uitableplan.height - 60, width: 45, height: 45, border_radius: 5, font_size: 30, hover_border: '#cc000a',
                callback: () => {
...
onMouseDown(x, y) {
    for (var i in this.uitableplans) {
        ...
        if (!uitableplan.inputDisabled) {
            ...
            if (!uitableplan.circle && !uitableplan.rect && !uitableplan.image && uitableplan.editable) {
                uitableplan.dragndrop.onMouseDown(x, y);
            }

            if (uitableplan.editable == true && (uitableplan.circle == true || uitableplan.rect == true || uitableplan.image == true)) {
...
onMouseUp(x, y) {
    for (var i in this.uitableplans) {
        ...
        if (uitableplan.active == true) {
            ...
            if (!uitableplan.inputDisabled) {
                if (uitableplan.editable == true && (uitableplan.circle == true || uitableplan.rect == true || uitableplan.image == true) && uitableplan.draw.mousedown_x != null) {
                    var x = 0;
                    var y = 0;
                    var width = 0;
                    var height = 0;
                    ...
                    if (uitableplan.rect) {
                        ...
                        uitableplan.dragndrop.add({
                            ...
                            background: ['#0000FF'], foreground: '#ffffff', border: '#0579ff', border_width: 0, grd_type: 'vertical', editable: true, active: uitableplan.active, distance: uitableplan.distance, grid_active: uitableplan.grid_active,
                        ...
                        uitableplan.dragndrop.add({
                            displaytext: '', group_id: uitableplan.active_room, contain_x: uitableplan.x, contain_y: uitableplan.y, contain_width: uitableplan.width - 225, contain_height: uitableplan.height - this.bottom_bar_height,
                            background: ['#0000FF'], foreground: '#ffffff', border: '#0579ff', border_width: 0, grd_type: 'vertical', editable: true, type: 'circle', active: uitableplan.active, distance: uitableplan.distance, grid_active: uitableplan.grid_active,
                            x: x, y: y, width: width, height: height, font_size: 25, angle: 0, addToUndoable: uitableplan.addToUndoable, isSelected: uitableplan.isSelected, callback: uitableplan.tableClicked,
                        });
                        uitableplan.addToUndoable();
                    }
                        ...
                        uitableplan.dragndrop.add({
                            ...
                            displaytext: '', group_id: uitableplan.active_room, contain_x: uitableplan.x, contain_y: uitableplan.y, contain_width: uitableplan.width - 225, contain_height: uitableplan.height - this.bottom_bar_height,
                            background: ['#0000FF'], foreground: '#ffffff', border: '#0579ff', border_width: 0, grd_type: 'vertical', editable: true, type: 'image', active: uitableplan.active, distance: uitableplan.distance, grid_active: uitableplan.grid_active,
                            x: x, y: y, width: width, height: height, font_size: 25, angle: 0, addToUndoable: uitableplan.addToUndoable, isSelected: uitableplan.isSelected, callback: uitableplan.tableClicked,
                        });
                        uitableplan.addToUndoable();
                    }
    ...
    for (var i in this.uitableplans) {
        ...
        if (uitableplan.active) {
            ...
            if (!uitableplan.inputDisabled) {
                ...
                else if (uitableplan.rect || uitableplan.circle || uitableplan.image) {
                    $(this.canvas).css('cursor', 'crosshair');
                }
