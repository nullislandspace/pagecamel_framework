class UIDialog {
    ...
    add(options) {
        ...
        options.list = new UIPayList(this.canvas);
            ...
            options.list.add(
                {
                    ...
                    background: ['#ffffff'], foreground: '#000000', border: '#000000', border_width: 3,
                    x: options.alpha_x + options.alpha_width / 2 - options.width / 2 + 20,
                    y: options.alpha_y + options.alpha_height / 2 - options.height / 2 + 80,
                    width: options.width - 40, height: options.height - 160, scrollbarwidth: 30,
