        ...
        for (var i in this.texts) {
            ...
            if (text.active) {
                if (text.height !== undefined) {
                    ctx.font = text.height +  'px ' + font_name;
                }
                else {
                    ctx.font = text.font_size +  'px ' + font_name;
                }
                ctx.strokeStyle = text.border;
                ctx.lineWidth = text.border_width;
                if(text.background !== undefined){
                    ctx.fillStyle = text.background[0];
                }
                else{
...
canvasuijs.addType('Text', UIText);