class UICheckBox {
    ...
    add(options) {
        if (options.displaytext !== undefined) {
            this.ctx.font = options.font_size +  'px ' + font_name;
    ...
    render(ctx) {
        for (var i in this.checkboxes) {
            ...
            if (checkbox.checked) {
                ...
                ctx.font = checkbox.height * 1.3 - checkbox.border_width +  'px ' + font_name;
            ...
            if (checkbox.displaytext !== undefined) {
                ...
                ctx.font = checkbox.font_size +  'px ' + font_name;
                this.ctx.font = checkbox.font_size +  'px ' + font_name;
