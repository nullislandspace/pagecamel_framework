class CXDropDown extends CXTextBox {
    constructor(ctx, x, y, width, height, is_relative = true, redraw = true) {
        ...
        this._dropdown_button.background = "transparent";
        ...
        this._dropdown_arrow.background = "transparent";
    ...
    set background(value) {
        this._dropdown_button.background = value;
        this._dropdown_arrow.background = value;
        this._dropdown_list.background = value;
        if (this._redraw) {
            this.draw(this._px, this._py, this._pwidth, this._pheight);
        }
    }
    get background() {
        return this._dropdown_button.background;
    }
}
