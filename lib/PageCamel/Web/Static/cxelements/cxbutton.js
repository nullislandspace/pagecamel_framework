class CXButton extends CXTextBox {
    ...
    _mouseInHandler = () => {
        ...
        if (this.allow_hover) {
            ...
            if (this.hover_text_color != undefined && this.text_color != this.hover_text_color) {
                this._default_text_color = this.text_color;
    ...
    _mouseOutHandler = () => {
        ...
        if (this.allow_hover) {
            ...
            if (this._default_text_color != undefined && this.text_color == this.hover_text_color) {
                this.text_color = this._default_text_color;
                changed = true;
            }
