...
/*export*/ class CXScrollList extends CXBox {
    ...
    */
    constructor(ctx, x, y, width, height, name = "", is_relative = true, redraw = true) {
        ...
        /** @protected */
        this._scroll_bar = new CXScrollBar(ctx, 0.95, 0.0, 0.05, 1.0, 'Scrollbar', true, false);
        this._scroll_bar.scrollbar.radius = 0.005;
        this._scroll_bar.radius = 0.005;
    ...
    addListItem(item) {
        ...
        var list_item = new CXScrollListItem(this._ctx, 0.0, this._item_height * this._scroll_list_items.length, 1 - this._scroll_bar.width, this._item_height, 'item', true, false);
    ...
    set list(list) {
        ...
        for (let i = 0; i < list.length; i++) {
            var list_item = new CXScrollListItem(this._ctx, 0.0, this._item_height * i, 1 - this._scroll_bar.width, this._item_height,'item', true, false);
