...
class CXTextInput extends CXTextBox {
    ...
    _showCursor(x) {
        ...
        var text_x = this._xpixel + this._border_width;
        console.log('mouse x: ' + x + ' text x: ' + text_x, 'mouse x - text x: ' + (x - text_x));
        ...
        for (var i = 0; i < this._text.length; i++) {
            ...
            console.log('text metrics: ' + text_metrics.width + 'text: ' + this._text.substring(0, i));
            if (text_metrics.width > x - text_x) {
                cursor_text_position = i;
                break;
            }
            if (i == this._text.length - 1) {
                cursor_text_position = i + 1;
            }
        }
        ...
        console.log('show cursor at ' + this._cursor_position);
