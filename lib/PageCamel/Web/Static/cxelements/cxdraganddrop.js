class CXDragAndDrop extends CXButton {
    ...
    _move = (x, y) => {
        ...
        if (min_x < this._px) {
            ...
            new_top_left_x = offset + this._px;
        }
        if (max_x > this._px + this._pwidth) {
            // prevent dragndrop from going out of bounds on the right
            var offset = max_x - this._center_x - this._width * this._pwidth / 2;
        ...
        if (min_y < this._py) {
            ...
            new_top_left_y = offset + this._py;
        }
        if (max_y > this._py + this._pheight) {
            // prevent dragndrop from going out of bounds on the bottom
            var offset = max_x - this._center_y - this._height * this._pheight / 2;
