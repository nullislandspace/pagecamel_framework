class CXDragAndDrop extends CXButton {
    ...
    _calculateCornerPoints(x = this._xpos, y = this._ypos) {
        ...
        var center_x = (x + this._width / 2) * this._pwidth;
        var center_y = (y + this._height / 2) * this._pheight;
        var [x1, y1] = this._rotatePoint(center_x, center_y, x * this._pwidth, y * this._pheight, this._angle);
        var [x2, y2] = this._rotatePoint(center_x, center_y, x * this._pwidth + this._width * this._pwidth, y * this._pheight, this._angle);
        var [x3, y3] = this._rotatePoint(center_x, center_y, x * this._pwidth + this._width * this._pwidth, y * this._pheight + this._height * this._pheight, this._angle);
        var [x4, y4] = this._rotatePoint(center_x, center_y, x * this._pwidth, y * this._pheight + this._height * this._pheight, this._angle);
    ...
    _move = (x, y) => {
        ...
        if (max_y > this._py + this._pheight) {
            ...
            var offset = max_y - this._center_y - this._height * this._pheight / 2;
