class CXTextBox extends CXBox {
    ...
    _drawText() {
        ...
        if (this.text) {
            ...
            if (this.auto_line_break) {
                for (var j in text_array) {
                    ...
                    if (this.border_width > 0) {
                        new_lines = autoLineBreak(this.ctx, text_array[j], this.widthpixel - this.border_width * 2);
                    } else {
                        new_lines = autoLineBreak(this.ctx, text_array[j], this.widthpixel);
                    }
            ...
            //this.ctx.strokeRect(this.xpixel + 10, start_y, this.widthpixel - 20, yoffs);
        }
    }
    _drawTextBox() {
        super._draw();
