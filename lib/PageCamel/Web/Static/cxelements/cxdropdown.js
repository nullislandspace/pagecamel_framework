...
export class CXDropDown extends CXTextBox {
    ...
    constructor(ctx, x, y, width, height, name = "", is_relative = true, redraw = true) {
        ...
        /** @protected */
        this._dropdown_button = new CXButton(ctx, 0, 0, this._field_width - 0.2, this._field_height, 'selectButton', true, false);
        /** @protected */
        this._dropdown_arrow = new CXArrowButton(ctx, this._field_width - 0.2, 0, 0.2, this._field_height, 'dropdownArrow', true, false);
        /** @protected */
        this._dropdown_list = new CXScrollList(ctx, 0, this._field_height, 1.0, 1.0 - this._field_height, 'dropdownlist', true, false);
