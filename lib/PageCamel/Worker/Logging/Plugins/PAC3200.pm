package PageCamel::Worker::Logging::Plugins::PAC3200;
#---AUTOPRAGMASTART---
use 5.020;
use strict;
use warnings;
...
Readonly my $MAX_RECV_LEN => 65_536;
...
sub crossregister {
    ...
    $self->register_plugin('work', 'PAC3200', 'PAC3200');
    return;
}
...
sub getData {
    ...
    my $pingmode;
    if ($EFFECTIVE_USER_ID and $OSNAME ne 'VMS' and $OSNAME ne 'cygwin') {
...
PageCamel::Worker::Logging::Plugins::PAC3200 - Log data from Siemens PAC3200

=head1 SYNOPSIS

  use PageCamel::Worker::Logging::Plugins::PAC3200;


=head1 DESCRIPTION

This module logs data from Siemens PAC3200 power meters via modbus/tcp. This is
a logging plugin.
...
Get and decode data packet from PAC3200
