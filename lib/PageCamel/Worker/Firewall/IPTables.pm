...
sub updateIPTables($self) {
    ...
    {
        open(my $ifh, '<', '/home/cavac/src/pagecamel_cavac/server/iptables/ip4tables.rules.template') or return; ## no critic (InputOutput::RequireBriefOpen)
        open(my $ofh, '>', '/home/cavac/src/pagecamel_cavac/server/iptables/ip4tables.rules') or return; ## no critic (InputOutput::RequireBriefOpen)
        print $ofh "# AUTO-GENERATED BY PAGECAMEL - DO NOT EDIT\n";
        print $ofh "# EDIT /home/cavac/src/pagecamel_cavac/server/iptables/ip4tables.rules.template instead and either send\n";
    ...
    {
        open(my $ifh, '<', '/home/cavac/src/pagecamel_cavac/server/iptables/ip6tables.rules.template') or return; ## no critic (InputOutput::RequireBriefOpen)
        open(my $ofh, '>', '/home/cavac/src/pagecamel_cavac/server/iptables/ip6tables.rules') or return; ## no critic (InputOutput::RequireBriefOpen)
        print $ofh "# AUTO-GENERATED BY PAGECAMEL - DO NOT EDIT\n";
        print $ofh "# EDIT /home/cavac/src/pagecamel_cavac/server/iptables/ip6tables.rules.template instead and either send\n";
        print $ofh "# a) a clacks NOTIFY iptables::needsupdate\n";
        print $ofh "#    or\n";
        print $ofh "# b) a PostgreSQL NOTIFY updateiptables\n";
        print $ofh "\n";
