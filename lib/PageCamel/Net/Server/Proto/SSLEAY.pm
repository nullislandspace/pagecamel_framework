# -*- perl -*-
#
#  PageCamel::Net::Server::Proto::SSLEAY - PageCamel::Net::Server Protocol module
#
#  $Id$
#
#  Original author:
...
sub object {
    ...
    @ISA = qw(IO::Socket::INET6) if $ISA[0] eq 'IO::Socket::INET' && PageCamel::Net::Server::Proto->requires_ipv6($server);
...
PageCamel::Net::Server::Proto::SSLEAY - Custom PageCamel::Net::Server SSL protocol handler based on Net::SSLeay.
...
Protocol module for PageCamel::Net::Server.  This module implements a secure
socket layer over tcp (also known as SSL).  See L<PageCamel::Net::Server::Proto>.
