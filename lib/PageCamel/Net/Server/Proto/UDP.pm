# -*- perl -*-
#
#  PageCamel::Net::Server::Proto::UDP - PageCamel::Net::Server Protocol module
#
#  $Id$
#
...
sub object {
    ...
    @PageCamel::Net::Server::Proto::TCP::ISA = qw(IO::Socket::INET6) if $PageCamel::Net::Server::Proto::TCP::ISA[0] eq 'IO::Socket::INET' && PageCamel::Net::Server::Proto->requires_ipv6($server);
...
PageCamel::Net::Server::Proto::UDP - PageCamel::Net::Server UDP protocol.
...
Protocol module for PageCamel::Net::Server.  This module implements the
...
normal command line parameters for a PageCamel::Net::Server.  See
L<PageCamel::Net::Server> for more information on reading arguments.
