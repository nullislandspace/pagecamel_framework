# -*- perl -*-
#
#  PageCamel::Net::Server::Proto::UNIX - PageCamel::Net::Server Protocol module
#
#  $Id$
#
#  Original author:
...
sub object {
    ...
    if ($class eq __PACKAGE__) {
        ...
        if ($u_type eq 'SOCK_DGRAM' || $u_type eq ''.SOCK_DGRAM()) { # allow for legacy invocations passing unix_type to UNIX - now just use proto UNIXDGRAM
            require PageCamel::Net::Server::Proto::UNIXDGRAM;
            return PageCamel::Net::Server::Proto::UNIXDGRAM->object($info, $server);
...
PageCamel::Net::Server::Proto::UNIX - PageCamel::Net::Server UNIX protocol.
...
SOCK_STREAM socket type.  See L<PageCamel::Net::Server::Proto>.
...
This can also be passed on the port line (see L<PageCamel::Net::Server::Proto>).
...
In addition to the standard NS_ methods of PageCamel::Net::Server::Proto classes,
