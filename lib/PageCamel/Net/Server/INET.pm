# -*- perl -*-
#
#  PageCamel::Net::Server::INET - PageCamel::Net::Server personality
#
#  $Id$
#
#  Original author:
...
package PageCamel::Net::Server::INET;
#---AUTOPRAGMASTART---
use 5.030;
use strict;
use warnings;
...
sub accept { # connection is already accepted
    ...
    ### PageCamel::Net::Server::INET will not do any determination of TCP,UDP,Unix
...
sub post_accept { # set up handles
    ...
    $self->{'server'}->{'client'} = PageCamel::Net::Server::INET::Handle->new();
...
################################################################
package PageCamel::Net::Server::INET::Handle;
...
=head1 SYNOPSIS
    ...
    use base qw(PageCamel::Net::Server::INET);

    sub process_request {
        #...code...
    }

    PageCamel::Net::Server::INET->run();
...
beyond the PageCamel::Net::Server base class.  This module operates by overriding
...
There are no additional hooks in PageCamel::Net::Server::INET.
