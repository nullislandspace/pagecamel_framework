# -*- perl -*-
#
#  PageCamel::Net::Server::Daemonize - Daemonization utilities.
#
#  $Id$
#
#  Original authors:
...
PageCamel::Net::Server::Daemonize - Safe fork and daemonization utilities

=head1 SYNOPSIS

    use PageCamel::Net::Server::Daemonize qw(daemonize);
