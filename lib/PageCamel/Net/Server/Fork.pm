# -*- perl -*-
#
#  PageCamel::Net::Server::Fork - PageCamel::Net::Server personality
#
#  $Id$
#
#  Original author:
...
sub run_client_connection {
    ...
    $SIG{'HUP'} = $SIG{'CHLD'} = $SIG{'CLD'} = $SIG{'INT'} = $SIG{'TERM'} = $SIG{'QUIT'} = 'DEFAULT';
    $SIG{'PIPE'} = 'IGNORE';
...
Process flow follows PageCamel::Net::Server until the post_accept phase.  At this
...
provided by the PageCamel::Net::Server base class.  See L<PageCamel::Net::Server>
