# -*- perl -*-
#
#  PageCamel::Net::Server::PreForkSimple - PageCamel::Net::Server personality
#
#  $Id$
#
#  Original author:
...
class, PageCamel::Net::Server::PreFork contains several other configurable
parameters.
...
hooks provided by the PageCamel::Net::Server base class.  See L<PageCamel::Net::Server>
