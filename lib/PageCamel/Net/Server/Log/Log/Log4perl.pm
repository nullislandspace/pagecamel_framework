# -*- perl -*-
#
#  PageCamel::Net::Server::Log::Log::Log4perl - PageCamel::Net::Server Logging module
#
#  $Id$
#
#  Original author:
...
sub initialize {
    ...
    my $logger = $prop->{'log4perl_logger'} || "PageCamel::Net::Server";
...
PageCamel::Net::Server::Log::Log::Log4perl - log via Log4perl
...
This module provides Log::Log4perl style logging to the PageCamel::Net::Server
system.
...
To begin using Log::Log4perl logging, simply set the PageCamel::Net::Server
...
This is the facility name. Defaults to "PageCamel::Net::Server".

=back

=head1 DEFAULT ARGUMENTS FOR PageCamel::Net::Server

The following arguments are available in the default C<PageCamel::Net::Server> or
C<PageCamel::Net::Server::Single> modules.  (Other personalities may use
...
base class.)
    ...
    log4perl_logger   "name"                   "PageCamel::Net::Server"
...
PageCamel::Net::Server.  It returns a single code ref that will be stored under
the log_function property of the PageCamel::Net::Server object.  That code ref
