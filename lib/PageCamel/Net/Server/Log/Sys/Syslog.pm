# -*- perl -*-
#
#  PageCamel::Net::Server::Log::Sys::Syslog - PageCamel::Net::Server Logging module
#
#  $Id$
#
#  Original author:
...
PageCamel::Net::Server::Log::Sys::Syslog - log via Syslog
...
This module provides Sys::Syslog logging to the PageCamel::Net::Server system.
...
To begin using Sys::Syslog logging, simply set the PageCamel::Net::Server
...
is passed the PageCamel::Net::Server object, the error that occurred while
logging and an arrayref containing the log level and the message.  In
turn, this calls the legacy PageCamel::Net::Server::handle_syslog_error method.
