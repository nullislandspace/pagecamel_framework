# -*- perl -*-
#
#  PageCamel::Net::Server::PSGI - Extensible Perl HTTP PSGI base server
#
#  $Id$
#
#  Original author:
...
PageCamel::Net::Server::PSGI - basic PageCamel::Net::Server based PSGI HTTP server class

=head1 TEST ONE LINER

    perl -e 'use base qw(PageCamel::Net::Server::PSGI); main->run(port => 8080, ipv => "*")'
    # runs a default echo server

=head1 SYNOPSIS

    use base qw(PageCamel::Net::Server::PSGI);
...
look at the L<Plack> and L<Starman> set of modules.  PageCamel::Net::Server::PSGI
...
rudimentary, then PageCamel::Net::Server::PSGI may be good for you.

PageCamel::Net::Server::PSGI takes PageCamel::Net::Server::HTTP one level farther.  It
begins with base type MultiType defaulting to PageCamel::Net::Server::Fork.  It
is easy to change it to any of the other PageCamel::Net::Server flavors by
...
This method has been overridden in PageCamel::Net::Server::PSGI - you should not
use it while using PageCamel::Net::Server::PSGI.  This overridden method parses
...
In addition to the command line arguments of the PageCamel::Net::Server::HTTP
