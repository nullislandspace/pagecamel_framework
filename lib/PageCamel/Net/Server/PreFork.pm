# -*- perl -*-
#
#  PageCamel::Net::Server::PreFork - PageCamel::Net::Server personality
#
#  $Id$
#
#  Original author:
...
package PageCamel::Net::Server::PreFork;
#---AUTOPRAGMASTART---
use 5.030;
use strict;
use warnings;
...
use base qw(PageCamel::Net::Server::PreForkSimple);
...
sub coordinate_children {
    ...
    # deleted SIG{'CLD'} reaped children
...
Please read the pod on PageCamel::Net::Server and PageCamel::Net::Server::PreForkSimple
first.  This module is a personality, or extension, or sub class, of
the PageCamel::Net::Server::PreForkSimple class which is a sub class of
PageCamel::Net::Server.  See L<PageCamel::Net::Server::PreForkSimple>.
...
Please see the sample listed in PageCamel::Net::Server.

=head1 COMMAND LINE ARGUMENTS

In addition to the command line arguments of the PageCamel::Net::Server base
class and the PageCamel::Net::Server::PreForkSimple parent class,
PageCamel::Net::Server::PreFork contains several other configurable parameters.
You really should also see L<PageCamel::Net::Server::PreForkSimple>.
...
See the documentation under L<PageCamel::Net::Server::PreForkSimple>.

=back

=head1 CONFIGURATION FILE

C<PageCamel::Net::Server::PreFork> allows for the use of a configuration file to
...
Process flow follows PageCamel::Net::Server until the loop phase.  At this point
...
provided by PreForkSimple.  See L<PageCamel::Net::Server::PreForkSimple>.
...
=item C<$self-E<gt>child_exception_hook()>

This hook occurs if child has an unhandled exception.
