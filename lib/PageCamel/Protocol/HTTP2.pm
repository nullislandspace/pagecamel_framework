...
PageCamel::Protocol::HTTP2 - HTTP/2 protocol implementation (RFC 7540)
...
=head1 SYNOPSIS
    ...
    print PageCamel::Protocol::HTTP2::ident_tls;           # h2

    # get protocol identification string for non-secure connections
    print PageCamel::Protocol::HTTP2::ident_plain;         # h2c

=head1 DESCRIPTION

PageCamel::Protocol::HTTP2 is HTTP/2 protocol implementation (L<RFC 7540|https://tools.ietf.org/html/rfc7540>) with stateful
...
=head2 L<PageCamel::Protocol::HTTP2::Client>

Client protocol decoder/encoder with constructor of requests

=head2 L<PageCamel::Protocol::HTTP2::Server>

Server protocol decoder/encoder with constructor of responses/pushes

=head2 L<PageCamel::Protocol::HTTP2::Connection>

Main low level module for protocol logic and state processing. Connection
object is a mixin of L<PageCamel::Protocol::HTTP2::Frame> (frame encoding/decoding),
L<PageCamel::Protocol::HTTP2::Stream> (stream operations) and L<PageCamel::Protocol::HTTP2::Upgrade>
(HTTP/1.1 Upgrade support)

=head2 L<PageCamel::Protocol::HTTP2::HeaderCompression>

Module implements HPACK - Header Compression for HTTP/2 (L<RFC 7541|https://tools.ietf.org/html/rfc7541>).

=head2 L<PageCamel::Protocol::HTTP2::Constants>

Module contains all defined in HTTP/2 protocol constants and default values

=head2 L<PageCamel::Protocol::HTTP2::Trace>
...
L<https://github.com/vlet/p5-Protocol-HTTP2/wiki> - PageCamel::Protocol::HTTP2 wiki
