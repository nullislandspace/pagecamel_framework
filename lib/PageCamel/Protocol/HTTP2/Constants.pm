package PageCamel::Protocol::HTTP2::Constants;
#---AUTOPRAGMASTART---
use v5.40;
use strict;
use diagnostics;
...
use constant {
    ...
    DEFAULT_ENABLE_CONNECT_PROTOCOL  => 0,  # RFC 8441 - disabled by default
...
our %EXPORT_TAGS = (
    ...
    limits => [
        qw(MAX_INT_SIZE MAX_PAYLOAD_SIZE PING_PAYLOAD_SIZE MAX_FCW_SIZE
          ...
          DEFAULT_MAX_HEADER_LIST_SIZE DEFAULT_ENABLE_CONNECT_PROTOCOL FRAME_HEADER_SIZE)
    ],
