package PageCamel::Protocol::HTTP2::HeaderCompression;
use strict;
use warnings;
use PageCamel::Protocol::HTTP2::Huffman;
use PageCamel::Protocol::HTTP2::StaticTable;
use PageCamel::Protocol::HTTP2::Constants qw(:errors :settings :limits);
