package PageCamel::Protocol::HTTP2::Frame;
#---AUTOPRAGMASTART---
use v5.40;
use strict;
use diagnostics;
...
use PageCamel::Protocol::HTTP2::Constants
  qw(const_name :frame_types :errors :preface :states :flags :limits :settings);
use PageCamel::Protocol::HTTP2::Frame::Data;
use PageCamel::Protocol::HTTP2::Frame::Headers;
use PageCamel::Protocol::HTTP2::Frame::Priority;
use PageCamel::Protocol::HTTP2::Frame::Rst_stream;
use PageCamel::Protocol::HTTP2::Frame::Settings;
use PageCamel::Protocol::HTTP2::Frame::Push_promise;
use PageCamel::Protocol::HTTP2::Frame::Ping;
use PageCamel::Protocol::HTTP2::Frame::Goaway;
use PageCamel::Protocol::HTTP2::Frame::Window_update;
use PageCamel::Protocol::HTTP2::Frame::Continuation;
...
my %decoder =
  map { $_ => \&{ 'PageCamel::Protocol::HTTP2::Frame::' . $frame_class{$_} . '::decode' } }
  keys %frame_class;
